...
To learn more about component libraries, check out the [ASP.NET Core Razor components class libraries](/aspnet/core/blazor/class-libraries&tabs=visual-studio).
